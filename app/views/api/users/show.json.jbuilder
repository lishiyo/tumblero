json.extract! @user, :id, :email, :created_at, :updated_at, :main_blog_id, :blog_ids
...
json.blogs @user.blogs, :id, :user_id, :name, :description, :avatar_url, :created_at, :updated_at, :handle, :followers_count, :tags, :posts_count